...
initializeAudioBehavior(buttonD1, 'd1.mp3', popupD1);
initializeAudioBehavior(buttonC2, 'ORIGINAL_BARAHAHbackground.WAV', popupC2);
initializeAudioBehavior(buttonB2, 'd2.mp3', popupB2);
initializeAudioBehavior(buttonB1, 'd2.mp3', popupB1);
initializeAudioBehavior(buttonA3, 'calculus2.mp3', popupA3);
initializeAudioBehavior(buttonA4, 'd2.mp3', popupA4);
initializeAudioBehavior(buttonBlueHall, 'piano.mp3', popupBlueHall);
initializeAudioBehavior(buttonRedTheater, 'ORIGINAL_red.mp3', popupRedTheater);
initializeAudioBehavior(buttonBlackBox, 'd2.mp3', popupBlackBox);

initializeAudioBehavior(buttonA1A, 'ORIGINAL_crying.mp3', popupA1A);
initializeAudioBehavior(buttonA1B, 'kitchen.mp3', popupA1B);
initializeAudioBehavior(buttonA1C, 'calculus.mp3', popupA1C);

initializeAudioBehavior(buttonA2A, 'snoring.mp3', popupA2A);
initializeAudioBehavior(buttonA2B, 'ORIGINAL_A2Baudio.mp3', popupA2B);
initializeAudioBehavior(buttonA2C, 'typing.mp3', popupA2C);

initializeAudioBehavior(buttonA5A, 'shower.mp3', popupA5A);
